...
#$(DIR__-MODULE_BUILD_DIRS): $(DIR__-BUILD_DIR)
#$(DIR__-BUILD_INCLUDE_DIR): $(patsubst %/,%,$(dir $(DIR__-BUILD_INCLUDE_DIR)))
#$(DIR__-BUILD_OBJ_DIR): $(patsubst %/,%,$(dir $(DIR__-BUILD_OBJ_DIR)))

#$(DIR__-BUILD_SUBDIRS) $(DIR__-MODULE_BUILD_DIRS):
#	$(MKDIR) $@
